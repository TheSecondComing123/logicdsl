...
class Expr:
    ...
    # ------------------------------------------------------------ arithmetic ops
    def __add__(self, o): o = Expr._E(o); return Expr._bin((self, o), lambda x, y: x + y)
    __radd__ = __add__

    def __sub__(self, o): o = Expr._E(o); return Expr._bin((self, o), lambda x, y: x - y)
    def __rsub__(self, o): o = Expr._E(o); return Expr._bin((o, self), lambda x, y: x - y)

    def __mul__(self, o): o = Expr._E(o); return Expr._bin((self, o), lambda x, y: x * y)
    __rmul__ = __mul__

    def __truediv__(self, o):  o = Expr._E(o); return Expr._bin((self, o), lambda x, y: x / y)
    def __floordiv__(self, o): o = Expr._E(o); return Expr._bin((self, o), lambda x, y: x // y)

    # NEW: modulo
    def __mod__(self, o):   o = Expr._E(o); return Expr._bin((self, o), lambda x, y: x % y)
    def __rmod__(self, o):  o = Expr._E(o); return Expr._bin((o, self), lambda x, y: x % y)

    def __pow__(self, o):  o = Expr._E(o); return Expr._bin((self, o), lambda x, y: x ** y)

    def __neg__(self): return Expr(lambda a, s=self: -s.eval(a))
    def abs(self):     return Expr(lambda a, s=self: abs(s.eval(a)))
    ...
    def __eq__(self, o): return self._cmp(o, lambda x, y: x == y)
    def __ne__(self, o): return self._cmp(o, lambda x, y: x != y)
    def __lt__(self, o): return self._cmp(o, lambda x, y: x <  y)
    def __le__(self, o): return self._cmp(o, lambda x, y: x <= y)
    def __gt__(self, o): return self._cmp(o, lambda x, y: x >  y)
    def __ge__(self, o): return self._cmp(o, lambda x, y: x >= y)
...
class Var:
    ...
    def __add__(self, o): return self.expr + o
    __radd__ = __add__

    def __sub__(self, o): return self.expr - o
    def __rsub__(self, o): return o - self.expr

    def __mul__(self, o): return self.expr * o
    __rmul__ = __mul__

    def __truediv__(self, o):  return self.expr /  o
    def __floordiv__(self, o): return self.expr // o

    # NEW modulo forwarders
    def __mod__(self, o):  return self.expr % o
    def __rmod__(self, o): return o % self.expr

    def __pow__(self, o): return self.expr ** o
    def __neg__(self):    return -self.expr

    # comparisons
    def __eq__(self, o): return self.expr == o
    def __ne__(self, o): return self.expr != o
    def __lt__(self, o): return self.expr <  o
    def __le__(self, o): return self.expr <= o
    def __gt__(self, o): return self.expr >  o
    def __ge__(self, o): return self.expr >= o
